...
//		return (self as NSString).size(withAttributes: [NSAttributedStringKey.font: NSFont.systemFont(ofSize: pointSize)])
//	}
//}
//
//extension CGPoint {
...
//
//	@IBInspectable var lineColor: NSColor = NSColor.green {
//		didSet {
...
//	}
//
//	@IBInspectable var circleColor: NSColor = NSColor.green {
//		didSet {
...
//
//	@IBInspectable var axisColor: NSColor = NSColor.white
...
//
//		let rect = NSMakeRect(0.0, 0.0, 0.0, 0.0)
...
//			let yOffset = yLabelSize.width + 5
//
//			let xScale = (bounds.width - yOffset - (xLabelSize.width/2) - 2)
//					/
//				(maxX - minX)
//			let yScale = (bounds.height - xOffset - (yLabelSize.height/2) - 2)
//				/
//				(maxY - minY)
//
//			t = CGAffineTransform(a: xScale, b: 0, c: 0, d: -yScale, tx: yOffset, ty: bounds.height - xOffset)
//
//		}
//
...
//	}
//
//	func drawAxes(in context: NSGraphicsContext?, usingTransform t: CGAffineTransform) {
//		if(context == nil) {
//			return
//		}
//		//context.saveGState()
...
//						   withAttributes:
//					[NSAttributedStringKey.font: NSFont.systemFont(ofSize: labelFontSize),
